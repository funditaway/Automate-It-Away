...
function publicPlan(acc) {
  ...
  return {
    ...
    note: b.note || "Free for now. Monthly later. We tell you before we charge."
  };
}
...
function requestMonthly(acc, actor) {
  ...
  acc.billing.note = "Monthly requested. Still free. No charge until the owner flips billing on.";
  acc.plan = "free";
...
function publicAccount(row) {
  ...
  return {
    ...
    plan: shop ? publicPlan(shop) : publicPlan({ plan: "free", billing: defaultBilling() })
  };
}
