...
Drop Talk Desk AI leftover: after DROP.md titled Desk AIs, Talk empty thread + DROP.md Ways in still said AIA AI answers. World Talk now says A Desk AI drafts the card. You still tap Yes or Stop. `AIA AI home is ai.aia` brand lines stay. Seat id `agent` stays. Collect HOLD. No silent send.
