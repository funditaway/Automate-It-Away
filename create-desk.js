    ...
    function fields() {
      ...
      <p class="hint">ai.aia is the AIA Internet brand. Packs travel as .aia files. Yes / Stop / Kill stay human. Collect stays HOLD. No silent money or mail. Create a .aia email for automations after the desk is open.</p>`;
        }
