...
["index.html", "how.html", "setup.html", "onboard.html", "drop.html", "login.html", "widget.html", "account.html", "examples.html", "help.html", "support.html"].forEach(function (name) {
  ...
  mustNot(html, "IoT", name + " IoT marketplace");
  mustNot(html, "robotics", name + " robotics labor");
  mustNot(html, "virtual phone", name + " virtual phone numbers");
});
...
mustNot(read("help.html"), "virtual phone", "help virtual phone numbers");
