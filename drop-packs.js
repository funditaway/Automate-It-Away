(function () {
  var PACK_META = {
    ...
    "aia-implement": { id: "aia-implement", name: "Four steps on this desk", kinds: ["leak", "pipe", "agent", "guard"], hint: "Find the leaks. Hook the pipes. Name a desk AI. You still tap. Collect stays HOLD." }
  };
