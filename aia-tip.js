...
(function () {
  var TIPS = {
    ...
    "drop-photo": {
      ...
      body: "Optional. Up to 8 files. Each under 8MB. Photos, documents, video, or HTML. They ride on the card. HTML opens in a sandboxed view — scripts stay off. Lands on this queue. You still tap Yes or Stop. Nobody sends money from here.",
