(function () {
  ...
  function migrateRulesTab() {
    document.querySelectorAll("#desk-nav [data-tab=\"rules\"], .desk-tabs [data-tab=\"rules\"]").forEach(function (el) {
      el.setAttribute("data-tab", "create");
      if (el.tagName === "A") el.setAttribute("href", "/create");
      var span = el.querySelector("span");
      if (span) span.textContent = "Create";
      else if (el.childNodes.length === 1) el.textContent = "Create";
      var path = el.querySelector("path");
      if (path) path.setAttribute("d", "M5 4h9l5 5v11H5zM14 4v5h5M8 13h8M8 17h5");
    });
  }
  ...
  function migratePipesTab() {
    document.querySelectorAll("#desk-nav [data-tab=\"pipes\"], .desk-tabs [data-tab=\"pipes\"]").forEach(function (el) {
      ...
      var path = el.querySelector("path");
      if (path) path.setAttribute("d", "M12 8v5l3 2M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0");
    });
  }
  ...
  function wireHrefs() {
    ...
    document.querySelectorAll("#desk-nav [data-tab=\"create\"], .desk-tabs [data-tab=\"create\"]").forEach(function (el) {
      if (el && el.tagName === "A") el.setAttribute("href", "/create");
    });
